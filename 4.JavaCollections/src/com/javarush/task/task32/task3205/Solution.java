...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        SomeInterfaceWithMethods proxyInstance = (SomeInterfaceWithMethods) Proxy.newProxyInstance(classLoader, interfaces, new CustomInvocationHandler(someInterfaceWithMethods));
