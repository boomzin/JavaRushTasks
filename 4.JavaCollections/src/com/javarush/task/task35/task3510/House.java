...
public class House <T>{
    ...
    public void enter(T resident) {
        if (residents.size() == 0){
            ...
            Object currentResident = residents.get(0);
            if ((currentResident instanceof Dog & resident instanceof Dog) | (currentResident instanceof Cat & resident instanceof Cat)) {
                residents.add(resident);
            }
        }
